...
namespace Neo\TestApi\Model\Api;

class TestApiManagement implements \Neo\TestApi\Api\TestApiManagementInterface
{
    ...
    public function __construct(
        \Neo\TestApi\Model\TestApiFactory $testApiFactory
